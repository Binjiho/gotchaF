...
//        view()->share('main_menu', 'M10');
     ...
     *                 @OA\Property (property="regist_edate", type="string", description="모집마감일", example="2024-01-30 00:00:00"),
     ...
     * )
     */
    public function showCompetition(String $sid)
    {
        return $this->compService->showCompetition($sid);
    }
     ...
     * )
     */
    public function deleteCompetition(String $sid)
    {
        return $this->compService->deleteCompetition($sid);
    }
