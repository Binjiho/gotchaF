...
export default function ConsultId() {
  ...
  const getConsult = function () {
    sendGet(`/api/boards/board-notice/${competitionId}/${consultId}`, null, res => {
      setConsult(res.data.board);
    });
  };
                ...
                {consult && (
                    <>
                        <div
                            ...
                            <div className={`flex flex-column `}>
                                <p className={`text-gray10 text-[13px]`}>{consult.writer}</p>
                  ...
                  {printDateTimeFormat(consult.created_at, "MM월 dd일")}
                        ...
                        <div className={`pt-[20px]`}>
                            ...
                            <p className={`pt-[20px] text-[15px] text-gray10`}>{consult.contents}</p>
                            <div className={`mt-[20px]`}>
                                <img src={consult.file_path} alt="" className={`w-full`} />
                            </div>
                        </div>
